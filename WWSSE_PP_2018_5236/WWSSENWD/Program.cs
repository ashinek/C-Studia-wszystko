    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            else
            {
                ...
                {
                    int c = NWD(a, b);
                    Console.WriteLine("NWD podanych liczb: a={0} i b={1} jest równe {2}", a, b, c);
                }
                else
                {
                    Console.WriteLine("nie podałeś liczb! Nie można obliczyć NWD. Proszę podać dwie liczby całkowite!");
                }
            }
        }
